package com.example.`Food Court`.ui.fragments
...
import com.example.`Food Court`.adapters.CategoriesRecyclerAdapter
import com.example.`Food Court`.adapters.MostPopularRecyclerAdapter
import com.example.`Food Court`.adapters.OnItemClick
import com.example.`Food Court`.adapters.OnLongItemClick
import com.example.`Food Court`.data.pojo.*
import com.example.`Food Court`.databinding.FragmentHomeBinding
import com.example.`Food Court`.mvvm.DetailsMVVM
import com.example.`Food Court`.mvvm.MainFragMVVM
import com.example.`Food Court`.ui.activites.MealActivity
import com.example.`Food Court`.ui.MealBottomDialog
import com.example.`Food Court`.ui.activites.MealDetailesActivity
import com.example.`Food Court`.util.Constants.Companion.CATEGORY_NAME
import com.example.`Food Court`.util.Constants.Companion.MEAL_AREA
import com.example.`Food Court`.util.Constants.Companion.MEAL_ID
import com.example.`Food Court`.util.Constants.Companion.MEAL_NAME
import com.example.`Food Court`.util.Constants.Companion.MEAL_STR
import com.example.`Food Court`.util.Constants.Companion.MEAL_THUMB

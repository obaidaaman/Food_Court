package com.example.`Food Court`.ui
...
import com.example.`Food Court`.adapters.FavoriteMealsRecyclerAdapter
import com.example.`Food Court`.data.pojo.MealDB
import com.example.`Food Court`.data.pojo.MealDetail
import com.example.`Food Court`.databinding.FragmentFavoriteMealsBinding

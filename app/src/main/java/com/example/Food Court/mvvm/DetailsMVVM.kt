package com.example.`Food Court`.mvvm

import android.app.Application
import android.util.Log
import androidx.lifecycle.*
import com.example.`Food Court`.data.db.MealsDatabase
import com.example.`Food Court`.data.db.Repository
import com.example.`Food Court`.data.pojo.MealDB
import com.example.`Food Court`.data.pojo.MealDetail
import com.example.`Food Court`.data.pojo.RandomMealResponse
import com.example.`Food Court`.data.retrofit.RetrofitInstance
